...
class JsonplaceholderclientpluginGrailsPlugin extends Plugin {
    ...
    def title = "Jsonplaceholderclientplugin" // Headline display name of the plugin
...
'''
    ...
    def documentation = "http://grails.org/plugin/jsonplaceholderclientplugin"
...
//    def scm = [ url: "http://svn.codehaus.org/grails-plugins/" ]
    ...
    Closure doWithSpring() { {->
            ...
            jsonPlaceHolderClientConfig(JsonPlaceHolderClientConfig) {
                serverUrl = config.getProperty("jsonplaceholderclient.server")
            }
